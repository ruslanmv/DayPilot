    ...
    <div className={cx('dp-shell', compact && 'dp-shell--compact')}>
      ...
      <main className="dp-core">
        {view === 'home' ? (
          ...
          <>
            {/* Calendar owns its whole header — title, connection chip and the
                Day/Week switch belong on one row there, and a second generic
                title above it just repeats the nav item you already clicked. */}
            {view !== 'calendar' && (
