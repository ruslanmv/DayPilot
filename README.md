...
| Orchestrator | `services/orchestrator` | Plan lifecycle, coding/email/design agents, approvals, jobs, security, **integration platform** (`integrations/`), **daily standup** (`standup/`: collector, compiler, schedule, thread resolver, delivery). |
